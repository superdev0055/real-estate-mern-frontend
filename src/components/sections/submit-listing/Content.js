    ...
    if (user === null) {
      ...
      SubmitListing = {
        BasicInformation: {
          ...
          period:
            listingState.period === undefined ? "Monthly" : listingState.period,
          space: listingState.space,
          // land: listingState.land,
          // building: listingState.building,
      ...
      // formData.append("land", BasicInformation.land);
      // formData.append("building", BasicInformation.building);
      formData.append("video", BasicInformation.video);
      formData.append("id", Details.id);
      formData.append("beds", Details.beds);
      formData.append("bathrooms", Details.baths);
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 form-group">
                        ...
                        <input
                          type="text"
                          className="form-control"
                          placeholder="Building (SQM)"
                          name="space"
                          value={listingState.building}
                          onChange={(e) =>
                            dispatch({
                              type: "UPDATE",
                              value: e.target.value,
