...
const bannerpost = [
  "https://real-estate-backend-9ph8.onrender.com/uploads/picture/16826981888802.jpg",
  "https://real-estate-backend-9ph8.onrender.com/uploads/picture/16826981888823.jpg",
];
...
const Banner = () => {
  ...
  const getData = () => {
    // const response = await fetch("https://real-estate-backend-9ph8.onrender.com/submitlisting/submit", {
    //   method: "GET",
    //   headers: {
              ...
              <div key={i}>
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" +
                      "https://real-estate-backend-9ph8.onrender.com/" +
                      item +
                      ")",
                  }}
                />
          ...
          <div className="acr-listing-section">
            ...
            <div className="acr-listing-section-body">
              <div className="acr-listing-section-price">
                ...
                <h3>${data.BasicInformation.price}</h3>
