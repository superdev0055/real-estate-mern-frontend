              ...
              <div className="listing compare-listing-item">
                <div className="listing-thumbnail">
                  <Link to="/listing-details-v1">
                    <img
                      src={
                        process.env.PUBLIC_URL + "/assets/img/listings/1.jpg"
                      }
                      alt="listing"
                    />
                  </Link>
              ...
              <div className="listing compare-listing-item">
                <div className="listing-thumbnail">
                  <Link to="/listing-details-v1">
                    <img
                      src={
                        process.env.PUBLIC_URL + "/assets/img/listings/2.jpg"
                      }
                      alt="listing"
                    />
                  </Link>
                ...
                <div className="listing-body">
                  <h5 className="listing-title">
                    ...
                    >
                      Theodore Lowe, Azusa New York 39531
                    </Link>{" "}
                  </h5>
                  <span className="listing-price">
              ...
              <div className="listing compare-listing-item">
                <div className="listing-thumbnail">
                  <Link to="/listing-details-v1">
                    <img
                      src={
                        process.env.PUBLIC_URL + "/assets/img/listings/3.jpg"
                      }
                      alt="listing"
                    />
                  </Link>
                ...
                <div className="listing-body">
                  <h5 className="listing-title">
                    ...
                    <Link
                      to="/listing-details-v1"
                      title="Cecilia Chapman, Mankato Mississippi 96522"
                    >
                      Cecilia Chapman, Mankato Mississippi 96522
                    </Link>{" "}
                  </h5>
                  <span className="listing-price">
                    2,600$ <span>/month</span>{" "}
                  </span>
                  <p className="listing-text">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry.
